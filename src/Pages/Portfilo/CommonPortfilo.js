          ...
          <div className="container mb-8   px-4 sm:px-5 md:px-10 lg:px-[60px]">
            <div className="py-12">
              ...
              >
                ...
                <li
                  className={`${
                    test === "Machine Learning" ? "text-[#FA5252]" : "fillter-btn"
                  } mr-4 md:mx-4`}
                ...
                <li
                  ...
                  onClick={() => handleSearch("Deep Learning")}
                >
                  Deep Learning
                </li>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 my-6">
                    <div className="space-y-2">
                      <p className="dark:text-white flex items-center text-[15px]  sm:text-lg ">
                        ...
                        <span className="font-medium transition-all duration-300 ease-in-out hover:text-[#ef4060]">
                          <a
                            href={singleData?.project}
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                            {singleData?.projectText}
                          </a>
                        </span>
                      </p>
                      <p className="dark:text-white flex items-center text-[15px]  sm:text-lg ">
                    ...
                    <div className="space-y-2">
                      <p className="dark:text-white flex items-center mt-2 lg:mt-0 text-[15px]  sm:text-lg ">
                        ...
                        <span className="font-medium transition-all duration-300 ease-in-out hover:text-[#ef4060]">
                          <a
                            href={singleData?.client}
                            target="_blank"
                            rel="noopener noreferrer"
                          >
                            {singleData?.clientText}
                          </a>
                        </span>
                      </p>
                      <p className="dark:text-white flex items-center text-[15px] sm:text-lg ">
